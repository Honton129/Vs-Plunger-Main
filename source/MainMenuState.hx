...
class MainMenuState extends MusicBeatState
{
	...
	public static var modVersion:String = '1.0.0'; //Mod Version Lol
	...
	var optionShit:Array<String> = ['story_mode', 'freeplay', #if ACHIEVEMENTS_ALLOWED 'awards', #end 'credits', 'options', #if !switch 'donate' #end];
	...
	override function create()
	{
		...
		DiscordClient.changePresence("In the Main Menu", "Selecting Option");
		#end
		...
		var versionShit:FlxText = new FlxText(12, FlxG.height - 64, 0, "VS. Plunger Mod v" + modVersion, 12);
